					...
					<div class="card card-primary" align="center">
						...
						<form
							...
							<div class="card-body">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" name="name" class="form-control"
											value="${ user.name }" placeholder="昵称">
									</div>
								</div>
								<div class="col-sm-6">
									<label>密码</label>
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>电话</label> <input type="text" name="phone"
											class="form-control" value="${ user.phone }" placeholder="电话">
									</div>
								</div>
								<div class="col-sm-6">
									<!-- select -->
									<div class="form-group">
										<label>用户类型</label> <select class="form-control"
											name="usertype">
									...
									<div class="form-group">
										<label>用户状态</label> <select class="form-control" name="state">
											...
											<c:if test="${ user.state == 0 }">
												<option selected value="0">注销</option>
											...
											<c:if test="${ user.state == 2 }">
												<option value="0">注销</option>
												<option value="1">正常</option>
												<option selected value="2">封号</option>
											</c:if>
										</select>
									</div>
								</div>
								...
								<div class="col-sm-6">
									<label>头像： </label> <img height="200" width="200"
										id="imagehead"
