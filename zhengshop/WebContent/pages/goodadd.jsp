			...
			<section class="content">
				<div class="container-fluid">
					<div class="card card-primary" align="center">
						...
						<!-- form start -->
						<form
							action="${pageContext.request.contextPath}/GoodsServlet?method=addGoodSunmit"
							...
							<div class="card-body">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<input type="text" name="gooddetail" class="form-control"
											placeholder="商品介绍">
									</div>
								</div>
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<input type="text" name="gooddiscount" class="form-control"
											placeholder="打折">
									</div>
								</div>
								<div class="col-sm-6">
									<select class="form-control" name="goodtypecode">
										<c:forEach items="${ goodtypearrayList }" var="gtl"
											varStatus="i">
