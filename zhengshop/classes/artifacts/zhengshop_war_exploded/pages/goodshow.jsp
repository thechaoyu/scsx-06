				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<a
								href="${pageContext.request.contextPath}/GoodsServlet?method=addGood&goodcode=${ goodcode }&goodname=${ goodname }&goodtypecode=${ goodtypecode }"
						...
						<div class="card-header">
							...
							<form
								action="${pageContext.request.contextPath}/GoodsServlet?method=findAllGoodsByNameOrType&firstpage=0"
								method="post">
								...
								<tbody>
									...
									<c:forEach items="${ goodlist }" var="gl" varStatus="i">
										<tr>
											...
											<th><a class="active"
												href="${pageContext.request.contextPath}/GoodsServlet?method=updateGood&goodname=${ gl.goodname }&goodtypecode=${ gl.goodType.goodtypecode }&goodcode=${gl.goodcode}&firstpage=${firstpage}">修改</a></th>
											<th><a class="active"
												href="javascript:mydelete('${ gl.goodname }','${ gl.goodType.goodtypecode }','${ gl.goodcode }')">删除</a>
											</th>
									...
									<c:if test="${ not empty goodlist }">
										...
										<c:if test="${ 0!=firstpage }">
											<li class="page-item"><a
												href="${pageContext.request.contextPath}/GoodsServlet?method=findAllGoodsByNameOrType&goodname=${ goodname }&goodtypecode=${ goodtypecode }&firstpage=${firstpage-1}"
										...
										<c:forEach begin="1" end="${maxPageNum}" step="1" var="i">
											...
											<c:if test="${ i!= firstpage }">
												<li class="page-item"><a
													href="${pageContext.request.contextPath}/GoodsServlet?method=findAllGoodsByNameOrType&goodname=${ goodname }&goodtypecode=${ goodtypecode }&firstpage=${ i }"
