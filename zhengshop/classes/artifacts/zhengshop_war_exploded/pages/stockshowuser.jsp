					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">商家库存表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							...
							<form
								action="${pageContext.request.contextPath}/StockServlet?method=findAllStockByUser1&firstpage=0"
								method="post">
								<div style="float: left;">
									<input style="width: 200px; margin-left: 5px;"
										value="${ goodname }" name="goodname" type="text"
										class="form-control" placeholder="商家商品名称">
								</div>
								<div style="float: left;">
								...
								<tbody>
									...
									<c:forEach items="${ goodlist }" var="gl" varStatus="i">
										<tr>
											...
											<th>
											<a class="active"
												href="${pageContext.request.contextPath}/StockServlet?method=addStockUser1&stockcode=${ gl.stock.stockcode }&goodname=${ gl.goodname }&goodtypecode=${ gl.goodType.goodtypecode }&goodcode=${gl.goodcode}&firstpage=${firstpage}">增加<br>库存</a>
											</th>
											<th>
											<a class="active"
												href="${pageContext.request.contextPath}/StockServlet?method=deleteStockUser1&stockcode=${ gl.stock.stockcode }&goodname=${ gl.goodname }&goodtypecode=${ gl.goodType.goodtypecode }&goodcode=${gl.goodcode}&firstpage=${firstpage}">减少<br>库存</a>
											</th>
									...
									<c:if test="${ not empty goodlist }">
										...
										<c:if test="${ 0!=firstpage }">
											<li class="page-item"><a
												href="${pageContext.request.contextPath}/StockServlet?method=findAllStockByUser1&goodname=${ goodname }&goodtypecode=${ goodtypecode }&firstpage=${firstpage-1}"
										...
										<c:forEach begin="1" end="${maxPageNum}" step="1" var="i">
											...
											<c:if test="${ i!= firstpage }">
												<li class="page-item"><a
													href="${pageContext.request.contextPath}/StockServlet?method=findAllStockByUser1&goodname=${ goodname }&goodtypecode=${ goodtypecode }&firstpage=${ i }"
