				...
				<div class="container-fluid">
					<div class="card card-primary" align="center">
						<div class="card-header">
							<h3 class="card-title">修改商品类型</h3>
						</div>
						<!-- /.card-header -->
						<!-- form start -->
						<form
							action="${pageContext.request.contextPath}/GoodsTypeServlet?method=updateGoodTypeSubmit"
							method="post">
							<div class="card-body">
								<div class="col-sm-6">
									<div class="form-group">
										<input type="hidden" name="goodtypecode" value="${goodType.goodtypecode }" >
										<input type="text" value="${goodType.typename }" name="typename" class="form-control"
											placeholder="商品类型名称">
									</div>
								</div>
