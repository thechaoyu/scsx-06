...
public class Orderdetail {
	...
	public Orderdetail(int id, String orderdetailcode, String usersellercode, String userbuyercode, String ordercode,
			String goodcode, String goodnumber, String state, String date, String price, String receiveraddress) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Orderdetail [id=" + id + ", orderdetailcode=" + orderdetailcode + ", usersellercode=" + usersellercode
				...
				+ ", goodnumber=" + goodnumber + ", state=" + state + ", date=" + date + ", price=" + price + ", receiveraddress= " + receiveraddress + "]";
	}
